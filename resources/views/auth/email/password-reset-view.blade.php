...
<img src="{{url('images/logo.png')}}" width="50%" alt="Evernote" border="0" style="width: 25%;display: flex;

margin: 0 auto;

padding-top: 20px;" /></font></a>

<h2 style="text-align: center; color: #ee8322;">Hello @if(isset($name)) {{$name}} @endif</h2>
