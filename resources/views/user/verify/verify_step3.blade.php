                      ...
                      <div class="steps">
                         <div class="align_with_next">
                            <div class="show_hide_buttons">
                               ...
                               <form method="post" action="saveresidence" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="admin_verif_status" value="0">
                               <input type="hidden" value="{{ Auth::user()->id }}" name="user_id">

                               <input type="file" name="residence" class="btn" accept="image/*" required><i class="fa fa-cloud-upload"></i> Browse </button>
                            </div>
                            <div class="verify_custom align_to_right">
                               <button type="submit" class="btn verf_next">Verify</button>
                            </form>
